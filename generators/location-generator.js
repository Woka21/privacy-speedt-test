/**
 * Location-Based Content Generator
 * Creates 50+ city-specific pages for local SEO domination
 */
...
// SEO-optimized template for location pages
const locationTemplate = (city) => `
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Internet Speed Test ${city.name}: Free Tool to Boost Your WiFi in ${city.state}</title>
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://yoursite.com/content/locations/speed-test-${city.name.toLowerCase().replace(/\s+/g, '-')}.html">
    
    <!-- Open Graph -->
    <meta property="og:title" content="Internet Speed Test ${city.name} | ${city.state}">
    <meta property="og:description" content="Test your internet speed in ${city.name}, ${city.state}. Average speed: ${city.avgSpeed} Mbps.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://yoursite.com/content/locations/speed-test-${city.name.toLowerCase().replace(/\s+/g, '-')}.html">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "WebApplication",
        "name": "Internet Speed Test ${city.name}",
        "description": "Test internet speed in ${city.name}, ${city.state}",
...
<body>
        ...
        <div class="container">
            <div class="speed-test-card">
                <div id="test-interface">
                    <p class="intro-paragraph">Ready to test my internet speed? Our tool delivers instant results in ${city.name}—uncovering download, upload, and ping metrics to help you demand better from your ISP. Compare your connection with ${city.isps.join(', ')} providers and see how you stack up against the ${city.avgSpeed} Mbps city average.</p>
                    <button id="start-test" class="primary-button">
                        <span>🚀 Test ${city.name} Speed</span>
                    </button>
                    <p class="privacy-note">✈️ All testing happens in your browser • No data collection</p>
                </div>
                ...
                <div id="results-container" class="hidden">
                    <div class="results-header">
                        <h2>Your ${city.name} Internet Speed Results</h2>
                    ...
                    <div class="results-main-grid">
                        ...
                        <div class="speed-card primary-card">
                            ...
                            <div class="speed-capabilities">
                                <div class="capability-item">✅ HD Streaming</div>
                                <div class="capability-item">✅ 4K Streaming</div>
                                <div class="capability-item">✅ Gaming</div>
                            </div>
                        </div>
                    ...
                    <div class="detailed-analysis">
                        ...
                        <div class="analysis-grid">
                            <div class="analysis-card">
                                <h4>🎬 Streaming Capabilities</h4>
                                <div class="capability-list" id="streaming-capabilities">
                                    <div class="capability-item">✅ Netflix HD (5 Mbps needed)</div>
                                    <div class="capability-item">✅ Netflix 4K (25 Mbps needed)</div>
                                    <div class="capability-item">✅ YouTube HD</div>
                                    <div class="capability-item">✅ Multiple streams</div>
                                </div>
                            </div>
                            
                            <div class="analysis-card">
                                <h4>💬 Video Call Quality</h4>
                                <div class="capability-list" id="video-call-capabilities">
                                    <div class="capability-item">✅ Zoom HD (3 Mbps needed)</div>
                                    <div class="capability-item">✅ Teams HD (3 Mbps needed)</div>
                                    <div class="capability-item">✅ Google Meet HD</div>
                                    <div class="capability-item">❌ Multiple HD calls</div>
                                </div>
                            </div>
                            ...
                            <div class="analysis-card">
                                ...
                                <div class="capability-list" id="gaming-capabilities">
                                    <div class="capability-item">✅ Online gaming (25 Mbps needed)</div>
                                    <div class="capability-item">✅ Game downloads</div>
                                    <div class="capability-item">✅ Streaming gameplay</div>
                                    <div class="capability-item" id="ping-gaming">✅ Low latency gaming</div>
                                </div>
                            </div>
                            
                            <div class="analysis-card">
                                <h4>☁️ Cloud & Upload Tasks</h4>
                                <div class="capability-list" id="upload-capabilities">
                                    <div class="capability-item">✅ Photo uploads</div>
                                    <div class="capability-item">✅ Cloud backups</div>
                                    <div class="capability-item">✅ File sharing</div>
                                    <div class="capability-item">❌ Large video uploads</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="speed-comparison">
                        ...
                        <div class="comparison-chart">
                            ...
                            <div class="chart-item">
                                ...
                                <div class="chart-value" id="city-download-value">${city.avgSpeed} Mbps</div>
                            </div>
                            <div class="chart-item">
                    ...
                    <!-- Local Context -->
                    <div class="local-context-section">
                        <h3>📍 ${city.name} Internet Context</h3>
                        <div class="local-stats">
                            <p><strong>Average speed in ${city.name}:</strong> ${city.avgSpeed} Mbps</p>
                            <p><strong>Population:</strong> ${city.population.toLocaleString()} residents</p>
                            <p><strong>Major providers:</strong> ${city.isps.join(', ')}</p>
                        </div>
                        <div class="local-comparison">
                            <p>Compare your results with other ${city.name} residents:</p>
                            <div class="comparison-meter">
                                <div class="meter-fill" style="width: ${city.avgSpeed/200 * 100}%"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content share-modal-content">
                            ...
                            <div class="share-preview">
                                <div class="share-result-summary">
                                    <div class="share-speed">🔥 <span id="share-download-speed">0</span> Mbps</div>
                ...
                <section class="faq-section">
                    <h2>Common ${city.name} Internet Questions</h2>
                    <div class="faq-container">
                        <details class="faq-item">
                            <summary>What's the fastest internet in ${city.name}?</summary>
                            <div class="faq-content">
                                <p>The fastest internet in ${city.name} is typically fiber from ${city.isps[0]}, offering the highest speeds in select areas. However, availability varies by neighborhood.</p>
                            </div>
                        </details>
                        <details class="faq-item">
                            <summary>Why is my ${city.name} internet slow at night?</summary>
                            <div class="faq-content">
                                <p>Internet speeds in ${city.name} often slow down during peak hours (7-11 PM) when most residents are streaming and using the internet. This is called network congestion.</p>
                            </div>
                        </details>
                        <details class="faq-item">
                            <summary>How much does internet cost in ${city.name}?</summary>
                            <div class="faq-content">
                                <p>Internet prices in ${city.name} range from $30-100/month depending on speed and provider. ${city.isps[0]} typically offers competitive rates, while premium providers may charge more for fiber connections.</p>
                            </div>
                        </details>
                    </div>
                </section>
                ...
                <section class="local-seo-section">
                    <h2>Internet Providers by ZIP Code in ${city.name}</h2>
                    <div class="zip-codes-grid">
                        ${city.zipCodes.map(zip => `
                        <div class="zip-code-item">
                            <h4>${zip}</h4>
                            <p>${city.isps.slice(0, 2).join(', ')} available</p>
                        </div>
                        `).join('')}
                    </div>
                    ...
                    <div class="nearby-cities">
                        <p>Also serving nearby areas:</p>
                        <div class="nearby-links">
                            <a href="/speed-test-${city.name.toLowerCase().replace(/\s+/g, '-')}-suburbs.html">${city.name} Suburbs</a>
                            <a href="/speed-test-${city.name.toLowerCase().replace(/\s+/g, '-')}-metro.html">${city.name} Metro Area</a>
                        </div>
                    </div>
                </section>
            </section>
    ...
    <footer class="footer">
        <div class="container">
            <p>&copy; 2024 ${city.name} Internet Speed Test | Zero Data Collection | <a href="/privacy">Privacy Policy</a></p>
        </div>
    </footer>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Add city context to results
            const originalDisplayResults = window.speedTestUI.displayResults;
            if (originalDisplayResults) {
                const cityContext = {
                    name: "${city.name}",
                    avgSpeed: ${city.avgSpeed},
                    isps: ${JSON.stringify(city.isps)}
                };

                // Enhance results with city data
                const enhancedDisplayResults = function(results) {
                    originalDisplayResults.call(this, results);

                    // Add city comparison
                    const cityComparison = document.createElement('div');
                    cityComparison.className = 'city-comparison-enhanced';
                    cityComparison.innerHTML = \`
                        <h4>📍 \${cityContext.name} Comparison</h4>
                        <p>Your speed vs \${cityContext.name} average (\${cityContext.avgSpeed} Mbps):</p>
                        <div class="comparison-bar">
                            <div class="your-speed" style="width: \${(results.download / cityContext.avgSpeed) * 100}%"></div>
                        </div>
                        <p><strong>\${results.download > cityContext.avgSpeed ? '✅ Above' : '❌ Below'} \${cityContext.name} average</strong></p>
                    \`;

                    const analysisSection = document.querySelector('.detailed-analysis');
                    if (analysisSection) {
                        analysisSection.appendChild(cityComparison);
                    }
                };
...
function generateLocationPages() {
    ...
    cities.forEach((city, index) => {
        ...
        const filename = `speed-test-${slug}.html`;
        const content = locationTemplate(city);
        ...
        // Progress indicator every 5 cities
        if ((index + 1) % 5 === 0) {
            console.log(`✅ Generated ${index + 1}/${cities.length} location pages...`);
        }
    });
    
    console.log(`\n🎉 Location generation complete!`);
    console.log(`📊 Total pages generated: ${generated}`);
    console.log(`📁 Location: content/locations/`);
    
    // Return stats
    return {
        total: generated,
        locations: cities.map(c => c.name),
        avgSpeed: Math.round(cities.reduce((sum, city) => sum + city.avgSpeed, 0) / cities.length)
    };
}
...
if (require.main === module) {
    const stats = generateLocationPages();
    console.log(`\n📈 Average city speed: ${stats.avgSpeed} Mbps`);
}